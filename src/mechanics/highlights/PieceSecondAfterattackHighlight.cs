...
public partial class PieceSecondAfterattackHighlight : PieceHighlight
{
    private bool _pseudo = false;
    
    public delegate void PSAHC();
    private PSAHC _whenClicked = () => { };

    public void PSAHInitialize(PSAHC whenClicked, bool pseudo = false)
    {
        _pseudo = pseudo;
